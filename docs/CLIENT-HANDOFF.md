...
| **Designer** | **[FIGMA-DESIGNER-GUIDE.md](FIGMA-DESIGNER-GUIDE.md)** — only doc they need | Optional: watch the [Figma → Code videos](https://drive.google.com/drive/u/1/folders/1ZkTWf9m8j6lk5mn6FQVqI5HaxhnlZIpW) to see how their Figma file ends up in generated code, and skim [README §Figma and UIX flow](../README.md#figma-and-uix-flow-layout-handoff) for context |
