...
> 🎬 **Watch it first:** two short [Figma → Code video walkthroughs](https://drive.google.com/drive/folders/1ZkTWf9m8j6lk5mn6FQVqI5HaxhnlZIpW) show this end-to-end before you set anything up.
...
- [Figma → Code video walkthroughs](https://drive.google.com/drive/folders/1ZkTWf9m8j6lk5mn6FQVqI5HaxhnlZIpW) — Two short screen-recorded demos of the Figma → code flow end-to-end. Watch first if you prefer a visual orientation before reading the docs.
