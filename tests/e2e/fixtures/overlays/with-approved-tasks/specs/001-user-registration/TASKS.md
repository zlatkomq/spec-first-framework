...
- [ ] T6: Unit tests for PasswordUtils
  ...
  - Tests: validation rules (min 8 chars), hashing produces hash, hash differs from input
...
- [ ] T7: Unit tests for UserRepository and InviteRepository
  ...
  - Tests: save/find operations, email uniqueness, invite consumption
...
- [ ] T8: Unit tests for RegistrationService
  ...
  - Tests: happy path, invalid invite, duplicate email, weak password, invite consumed
...
- [ ] T9: Integration test for registration flow
  ...
  - Tests: full happy path with real repositories, duplicate registration attempt
...
- [Source: DESIGN.md#Architecture] — Component structure
- [Source: DESIGN.md#Data Model] — User and Invite entities
- [Source: SPEC.md#Acceptance Criteria] — BDD criteria for validation
