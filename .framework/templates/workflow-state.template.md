...
- **stepsCompleted**: Which workflow steps are done (e.g. `['step-01-spec', 'step-02-design', 'step-02b-uix']`).
- **uixSkipped**: Set to `true` when step 3 (UIX Spec) is skipped (no Figma for this spec). Used for reporting; resume still continues to Task Breakdown.
