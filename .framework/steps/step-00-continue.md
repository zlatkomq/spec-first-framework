...
**If `featureBranch` is empty** (steps 1–4, no implementation yet):
...
step 4 (Tasks) as last completed step. This may indicate implementation happened
...
- **[B]:** Ask which step (1–6). Trim `stepsCompleted` to keep entries before the chosen step (1=Spec, 2=Design, 3=UIX Spec, 4=Tasks, 5=Implement, 6=Review). Reset all counters. Load the corresponding step file.
- **[X]:** STOP.
...
Next step: {nextStepFile} (Step N of 6)
{If mid-step-04: "Implementation progress: {[x] count} of {total} tasks completed."}

[C] Continue — proceed to {next step}
[B] Back to a step — [1] Spec [2] Design [3] UIX Spec [4] Tasks [5] Implement
[X] Exit
```
...
- **[B]:** Trim `stepsCompleted` per chosen step:
  ...
  - Back to UIX Spec (3): keep up to `['step-01-spec', 'step-02-design']`
  - Back to Tasks (4): keep up to `['step-01-spec', 'step-02-design', 'step-02b-uix']`
  - Back to Implement (5): keep up to `['step-01-spec', 'step-02-design', 'step-02b-uix', 'step-03-tasks']`
