...
**Progress: Step 2 of 6** — Next: UIX Spec (Figma)
...
- Ask: "Review the DESIGN. Approve to continue to UIX Spec (Figma), or tell me what to change. (Say [V] to view SPEC.md, [B] to go back to Spec, or [X] to exit.)"
