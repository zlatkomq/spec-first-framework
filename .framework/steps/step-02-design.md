...
**Progress: Step 2 of 5** — Next: UIX Spec (optional) → Task Breakdown
...
[C] Continue — proceed to UIX Spec / Task Breakdown (Step 2b/3)
...
- **IF [C] Continue:**
  ...
  2. Read fully and follow: `{nextStepFile}` (step-02b-uix.md — UIX Spec, optional; auto-skips to step-03-tasks if no Figma).
- **IF [V] View SPEC.md:**
