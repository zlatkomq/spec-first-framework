...
Run the full spec-first feature workflow for a given spec: create/update SPEC, DESIGN, UIX (optional Figma mapping), TASKS, implement, and review — step by step with menus to continue, go back, or exit.
...
- Step files: `.framework/steps/step-00-continue.md` through `step-05-review.md` (includes optional `step-02b-uix.md`)
- State template: `.framework/templates/workflow-state.template.md`
- Rules: `.cursor/rules/spec-creation.mdc`, `design-creation.mdc`, `uix-creation.mdc`, `task-creation.mdc`, `implementation.mdc`, `code-review.mdc`
